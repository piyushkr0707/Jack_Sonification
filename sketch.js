...
function preload() 
{
  ...
  bass_sound    = loadSound(href="tree/gh-pages/assets/bass.mp3");
  snare_sound   = loadSound(href="tree/gh-pages/assets/snare.mp3");
  highHat_sound = loadSound(href="tree/gh-pages/assets/High hat.mp3");
