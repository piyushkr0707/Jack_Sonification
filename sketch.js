...
function preload() 
{
  ...
  bass_sound    = loadSound(href="blob/master/assets/Bass.mp3");
  snare_sound   = loadSound(href="blob/master/assets/snare.mp3");
  highHat_sound = loadSound(href="blob/gh-pages/assets/High hat.mp3");
